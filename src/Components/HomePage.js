	...
	return (
						...
						<motion.div layout transition={{ duration: 0.6 }}>
							<motion.div layout>
								<Box fontSize={["15px", "20px", "24px", "24px"]}>
									I am an an Indian writer for television and screen who has been asking the question 'Why not?' since I was a kid. As my parents did not have the answer to my constant questioning of the world, I started investigating my queries in my daydreams. Those daydreams have now taken the form of a lifelong quest for storytelling. I settled on this as my life's purpose only after majoring in journalism after she majored in journalism where i learned the useful inverted pyramid and made a bunch of zero-budget student films.
		{!selected && (<div onClick={() => setSelected(!selected)} className="OpenTags">Read More...</div>)}
							...
							{selected && (
								<motion.div>
									<Box fontSize={["15px", "20px", "24px", "24px"]}>
										Although I hold an MFA degree in Dramatic Writing from New York University's Tisch School of the Arts, I hold my (functionally dysfunctional) family more dearly as they are her biggest source of inspiration in life and my writings. I tend to write all of my stories as letters to my loved ones. I also like to make sure that each story of mine has humor and specificity at its core. Once upon a time, I used to feel like I am travelling the world when I consumed a story a day, and that's what I wish for the folks who experience my work. 

										And one last thing, I hope to build my own secret library one day so that I can daydream (and write) in peace.
